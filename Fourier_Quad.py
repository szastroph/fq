...
class Fourier_Quad:
    ...
    def shear_est(self, gal_image, psf_image, noise=None, F=False,G = False):
        r"""
    ...
    def rw_snr(self, image, noise):

        a, b = self.get_radius_new(image, noise)[1:3]
        snr = b / numpy.sqrt(len(a)) / noise
        return snr
